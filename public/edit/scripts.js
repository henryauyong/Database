...
async function getTeacherInfo() {
    ...
    for (; projectTableIndex < data[4].length; projectTableIndex++) {
        console.log(data[4][projectTableIndex].Identity)
        projectTable.innerHTML += '<tr><td><input type="hidden" name="projectName' + projectTableIndex + '" value="' + data[4][projectTableIndex].Name + '" />' + data[4][projectTableIndex].Name + '</td><td><input type="hidden" name="projectTime' + projectTableIndex + '" value="' + data[4][projectTableIndex].Time + '" />' + data[4][projectTableIndex].Time + '</td><td><input type="hidden" name="projectSerial' + projectTableIndex + '" value="' + data[4][projectTableIndex].Serial_Code + '" />' + data[4][projectTableIndex].Serial_Code + '</td><td><input type="hidden" name="projectIdentity' + projectTableIndex + '" value="' + data[4][projectTableIndex].Identity + '" />' + data[4][projectTableIndex].Identity + '</td><td><div class="flex w-full justify-end"><button class="btn btn-sm btn-outline btn-error projectTableDelButton" type="button">刪除</button></div></td></tr>'
